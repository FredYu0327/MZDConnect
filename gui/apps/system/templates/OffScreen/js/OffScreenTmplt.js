...
/*
 * Common.js will call this to update the clock.
 */
OffScreenTmplt.prototype.updateClock = function()
{
    this.offScreenCtrl.updateClock();
}
...
framework.registerTmpltLoaded("OffScreenTmplt", ["apps/system/controls/OffScreen"]);
