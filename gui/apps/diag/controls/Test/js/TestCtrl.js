...
{    
    ...
    this.properties = {
        ...
        "longPressCallback"    : null,// (function)
        "settleTime" : null,
    ...
    this.delHandlerMouseDown = this._delHandlerMouseDown.bind(this);
    this.delHandlerMouseUp = this._delHandlerMouseUp.bind(this);
...
TestCtrl.prototype.init = function()
{
    ...
    this.btnDel.addEventListener(TestCtrl.prototype._CLICKEVENT, this.delHandler, false);
    this.btnDel.addEventListener(TestCtrl.prototype._MOUSEDOWNEVENT, this.delHandlerMouseDown, false);
    this.btnDel.addEventListener(TestCtrl.prototype._MOUSEUPEVENT, this.delHandlerMouseUp, false);
    ...
    this.btnEnter.addEventListener(TestCtrl.prototype._CLICKEVENT, this.enterHandler, false);
    ...
    this.btnClear.addEventListener(TestCtrl.prototype._CLICKEVENT, this.clearHandler, false);
    ...
    this.btnExit.addEventListener(TestCtrl.prototype._CLICKEVENT, this.exitHandler, false);
    ...
    for (var i=0; i<10; i++)
    {
        ...
        this.btns[i] = temp
        this.btns[i].addEventListener(TestCtrl.prototype._CLICKEVENT, this.btnSelectCallback, false);
...
TestCtrl.prototype._delHandlerMouseDown = function(e)
{
    //log.info("inside delHandlerMouseDown");
    if(this.settleTimeOut)
    {
        clearTimeout(this.settleTimeOut);
        this.settleTimeOut = null;
    }
    var settleTimeCallback = this._settleTimeCallback.bind(this);
    this.settleTimeOut = setTimeout(settleTimeCallback, this.properties.settleTime);
}

TestCtrl.prototype._settleTimeCallback = function(e)
{
    //log.info("inside _settleTimeCallback");
    if (this.properties.longPressCallback)
    {
...
TestCtrl.prototype._delHandlerMouseUp = function(e)
{  
    clearTimeout(this.settleTimeOut);
}
...
TestCtrl.prototype.cleanUp = function()
{
    ...
    this.btnEnter.removeEventListener(TestCtrl.prototype._CLICKEVENT, this.enterHandler, false);
    this.btnExit.removeEventListener(TestCtrl.prototype._CLICKEVENT, this.exitHandler, false);
    this.btnClear.removeEventListener(TestCtrl.prototype._CLICKEVENT, this.clearHandler, false);
    this.btnDel.removeEventListener(TestCtrl.prototype._CLICKEVENT, this.delHandler, false);
    for (var i=0; i<this.btns.length; i++)
    {
        this.btns[i].removeEventListener(TestCtrl.prototype._CLICKEVENT, this.btnSelectCallback, false);
    }
...
TestCtrl.prototype.activateAnyKey = function(state,key)
{
    ...
    if(state === true)
    {
        ...
        this.btns[key].addEventListener(TestCtrl.prototype._CLICKEVENT, this.btnSelectCallback, false);
    }
    else
    {
         this.btns[key].className = ('btn'+key+"Disable");
         this.btns[key].removeEventListener(TestCtrl.prototype._CLICKEVENT, this.btnSelectCallback, false);
    }
    this.properties.length = 0;
}
...
TestCtrl.prototype.activateDel = function(state)
{
    ...
    else
    {
        this.btnDel.className = 'delDisable';
        this.btnDel.removeEventListener(TestCtrl.prototype._CLICKEVENT, this.delHandler, false);
        this.btnDel.removeEventListener(TestCtrl.prototype._MOUSEUPEVENT , this.delHandlerMouseUp, false);
        this.btnDel.removeEventListener(TestCtrl.prototype._MOUSEDOWNEVENT, this.delHandlerMouseDown, false);
    }
    this.properties.length = 0;
}
//To clear input
