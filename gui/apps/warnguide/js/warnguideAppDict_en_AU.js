var Localization_warnguideAppDict_en_AU = {
    ...
    "BrakOverrideSysErrorShrt" : "Brake Override Syst. Malfunction",
    ...
    "FOWMRCCDRSSRadarSoilingShrt" : "All Radar Malfunctions",
    ...
    "EngOilPressureErrorLong" : "Low Engine Oil Pressure. Stop the vehicle immediately in a safe place, turn Off the Engine, and inspect the Engine Oil Level. Add Oil if necessary. Have the vehicle checked by a dealer immediately if this Indicator turns On after adding Oil or the EngineOil level is OK.",
    ...
    "RoadSurfaceIcingCautionLong" : "Outside Temperature is 4°C or Lower.\nWatch for Icy Road Surfaces while driving.",
    ...
    "MRCCUnavailableLong" : "Mazda Radar Cruise Control (MRCC) is currently unavailable.",
    "SBSBrakeUnavailableLong" : "SBS Brake is currently unavailable.",
    "SBSBrakeMRCCUnavailableLong" : "SBS Brake/MRCC is currently unavailable.",
    "SCBSSysErrorLong" : "Smart City Brake Support (SCBS) Malfunction. Have the vehicle checked by a dealer immediately.",
    "SCBSWindshieldSoilingLong" : "Smart City Brake Support (SCBS) Malfunction. Clean the front Windshield.  Have the vehicle checked by a dealer if this Indicator stays On.",
    "SCBSUnavailableLong" : "Smart City Brake Support (SCBS) is currently unavailable.",
...
framework.registerAppDictLoaded("warnguide", "en_AU");