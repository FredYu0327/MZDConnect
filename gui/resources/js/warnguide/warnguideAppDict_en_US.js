var Localization_warnguideAppDict_en_US = {
	...
	"AutoLevelSystemErrorLong": "Headlight Auto-leveling System Malfunction.\nHave the vehicle checked by a dealer if this Indicator stays On.",
	"AutoLevelSystemErrorShrt": "Auto-leveling System Malfunction",
	...
	"ElectricParkingBrakeHighLong": "A malfunction has occurred in the parking brake system.\nConsult your Mazda Dealer for inspection.",
	"ElectricParkingBrakeLong": "A malfunction has occurred in the parking brake system.\nConsult your Mazda Dealer for inspection.",
	"ElectricParkingBrakeShrt": "Parking Brake System Malfunction",
	"ElectricVacuumPumpSystemMalfunctionLong": "A malfunction has occurred in the electric vacuum pump system.\nLeaving this issue unresolved may cause the system to fail, which will pose unexpected danger or damage.\nConsult your Mazda Dealer immediately and have the malfunction inspected.",
	...
	"FWDSysErrorLong": "4WD System Malfunction or Tire Size is different between the Front and Rear Tires.\nHave the vehicle checked by a dealer.",
	...
	"FuelCapInspectionLong": "The Fuel Cap may not be installed properly.\nCheck that the Fuel Cap has been installed and tightened properly. After installing and tightening the Fuel Cap properly, this Indicator will not turn Off for a few drive cycles until it can be confirmed that the system is OK.  Have the vehicle checked by a dealer if this Indicator stays On.",
	...
	"HBCLDWSWindshieldFogLong": "High Beam Control (HBC)/Lane Departure Warning System (LDWS) Malfunction. Defrost the Windshield.  Have the vehicle checked by a dealer if this Indicator stays On.",
	...
	"HBCLLDWSCamDisconnectLong": "High Beam Control (HBC)/Lane Departure Warning System (LDWS) Malfunction. Clean the Windshield.  Have the vehicle checked by a dealer if this Indicator stays On.",
	...
	"HeadlightSystemErrorLongJ03": "A malfunction has occurred in the headlight system.\nIf the warning light blinks continuously, consult your Mazda Dealer.",
	"HighEngineOillevel": "High Engine Oil Level",
	"HighEngineOillevelDetail": "Engine oil level is too high. Please replace oil. ",
	...
	"IstopSysErrorLong": "i‑stop operation is not possible.\nHave your vehicle checked at a Mazda dealer.",
	...
	"LowEngineOillevel": "Low Engine Oil Level",
	"LowEngineOillevelDetail": "Engine oil level is too low.  Please add oil.",
	"LowFuelLong": "Fuel Tank Level is Low.\nRefuel the vehicle soon.",
	"LowFuelShrt": "Low Fuel",
	"LowTireAirPressureFlatLong": "If the tire pressure drops dramatically after the TPMS warning light has illuminated, or if the tire is punctured, the flat tire warning light will also be illuminated. \nIf a run-flat tire is punctured, carefully drive the vehicle to the nearest Mazda Dealer and have the tire changed.",
	"LowTireAirPressureLong": "Low Tire Air Pressure in one or more Tires.\nCheck the Air Pressure of the Tires and adjust to the correct Air Pressure.  Press the TPMS SET switch after adjusting the Tire Pressure until you hear a Beep.",
	"LowTireAirPressureShrt": "Low Tire Air Pressure",
	...
	"OilLevelSystemMalfunction": "Oil System Malfunction\n",
	"OilLevelSystemMalfunctioningDetail": "There is a malfunction in the oil level system. Please have the vehicle checked by a Mazda dealer. ",
	...
	"RvmSysErrorLong": "There is an error in the RVM System.\nCheck for abnormalities in the Rear Bumper Surface, and clean if soiled or covered with snow. Have your vehicle checked by a Mazda dealer if this Warning Lamp stays On.",
	...
	"SBSMRCCDRSSRadarSoilingShrt": "SBS/MRCC/DRSS Radar Error",
	...
	"SedimenterWarningLong": "The amount of water accumulated in the Sedimenter exceeds the rated amount. Have the vehicle checked by a dealer if this Indicator stays On.",
	"SedimenterWarningShrt": "Sedimenter Inspection",
	"SystemInspectionLong": "The Differential Oil Temperature is Abnormally High or a Large Rotational Difference has occurred in the Front and Rear Tires (such as when trying to get out from mud). Stop the vehicle in a safe place and continue to drive after the Warning Indicator has turned Off. Have the vehicle checked by a dealer if this Indicator stays On.",
	"SystemInspectionShrt": "4WD System Inspection",
	"TpmsSysErrorLong": "Tire Pressure Monitoring System (TPMS) Malfunction. Have the vehicle checked by a dealer.",
...
framework.registerAppDictLoaded("warnguide", "en_US");